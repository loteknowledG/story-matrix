  ...
  return (
    ...
    >
      <div className="aspect-square bg-gray-100 rounded-2xl overflow-hidden relative shadow-sm group-hover:shadow-md transition-all border border-gray-100">
        {story.coverMomentUrl ? (
          <img
            src={story.coverMomentUrl}
            alt={story.title}
      ...
      <div>
        <h3 className="font-medium text-gray-900 leading-tight group-hover:text-blue-600 transition-colors truncate">{story.title}</h3>
